...
<span> Градация запросов на подгрузку билетов по интервалам для того чтоб пользователь имел возможность начать фильтрацию до подгрузки полного колличества билетов.</span>
